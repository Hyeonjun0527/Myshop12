...
<script type="text/javascript" src="/js/CommonScript.js">
</script>
	...
	<tr>
		...
		<td class="ct_write01">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26">
						<input type="text" name="Input3" class="ct_input_g" style="width:370px; height:19px" value="한글123abc" fieldTitle="char" char="skn">
					</td>
				</tr>
				<tr>
					<td height="22" colspan="3">
